...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "graphql/schema.graphql", Input: `type Movie {
  id: Int!
  title: String!
}
...
func (ec *executionContext) field_Mutation_createMovie_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewMovie2githubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐNewMovie(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateMovie(rctx, args["input"].(NewMovie))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNMovie2ᚖgithubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_movies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNMovie2ᚕᚖgithubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewMovie(ctx context.Context, obj interface{}) (NewMovie, error) {
	var it NewMovie
...
func (ec *executionContext) _Movie(ctx context.Context, sel ast.SelectionSet, obj *Movie) graphql.Marshaler {
	fields := graphql.CollectFields(ec.RequestContext, sel, movieImplementors)
...
func (ec *executionContext) marshalNMovie2githubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx context.Context, sel ast.SelectionSet, v Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖgithubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx context.Context, sel ast.SelectionSet, v []*Movie) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖgithubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖgithubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐMovie(ctx context.Context, sel ast.SelectionSet, v *Movie) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewMovie2githubᚗcomᚋYellowCoderᚋmovieᚑfinderᚋgraphqlᚐNewMovie(ctx context.Context, v interface{}) (NewMovie, error) {
